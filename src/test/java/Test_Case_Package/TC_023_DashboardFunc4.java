...
public class TC_023_DashboardFunc4 extends _3Baseclass_QuizFunc{
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 /// here we pass the Mobile number & click on Login button..
	      ...
	      WebElement myAcc=	driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/dashboard']"));
	  	 ...
	  	 Thread.sleep(3000);
	 	 WebElement failedAttempt = driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/test/failed-attempt']"));
	 	failedAttempt.click();	 
	 	 WebElement FailAtText = driver.findElement(By.xpath("//h4[normalize-space()='Failed Attempt']"));

	  	  if (FailAtText.isDisplayed()) {

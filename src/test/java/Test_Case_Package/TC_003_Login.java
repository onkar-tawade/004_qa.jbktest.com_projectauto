...
public class TC_003_Login extends _1Baseclass_Login {

	//// Test case to verify that Login Functionality with valid Credentials but which is not registered.
	...
	public void Valid_Invalid_LoginTC(String mobNum ) throws InterruptedException{
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 if (mobNum.equals("9022737332") || mobNum.equals("7588573215")) {
	...
	@DataProvider(name="dataL" , indices = {2} ) /// here in indices we pass which rows data we want

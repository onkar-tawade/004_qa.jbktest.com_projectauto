...
public class TC_016_SignUP13 extends _2Baseclass_SignUp  {
	...
	@Test(dataProvider = "dataS")
		...
		/// here we select the Topics for Testing quiz...
         ...
         WebElement procBtn = driver.findElement(By.xpath("//div[@id='quizotpforsignup']//h3[@id='quizheading']"));
		 SignInConditions sgnc = new SignInConditions();
		 sgnc.condSignUp(convertNumtoString,mNum, errorEmail , procBtn);
	...
	@DataProvider(name="dataS" , indices = {11}) /// here in indices we pass which rows data we want

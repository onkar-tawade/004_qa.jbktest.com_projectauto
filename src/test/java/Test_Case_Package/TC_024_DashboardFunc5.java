...
public class TC_024_DashboardFunc5 extends _3Baseclass_QuizFunc{
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 /// here we pass the Mobile number & click on Login button..
	      ...
	      WebElement myAcc=	driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/dashboard']"));
	  	 ...
	  	 Thread.sleep(3000);
	 	 WebElement timeLine = driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/timeline']"));
	 	timeLine.click();	  	  
	  	  if (driver.getTitle().equals("Timeline")) {

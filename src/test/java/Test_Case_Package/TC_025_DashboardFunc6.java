...
public class TC_025_DashboardFunc6 extends _3Baseclass_QuizFunc{
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 /// here we pass the Mobile number & click on Login button..
	      ...
	      WebElement myAcc=	driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/dashboard']"));
	  	 ...
	  	 Thread.sleep(3000);
	 	 WebElement coveredTopics = driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/topics-covered']"));
	 	 coveredTopics.click();	  	  
	  	  if (driver.getTitle().equals("Topics Covered")) {

...
public class TC_022_DashboardFunc3 extends _3Baseclass_QuizFunc{
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 /// here we pass the Mobile number & click on Login button..
	      ...
	      WebElement myAcc=	driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/dashboard']"));
	  	 ...
	  	 Thread.sleep(3000);
	 	 WebElement goodScore = driver.findElement(By.xpath("//a[@href='https://thekiranacademy.com/test/test/good-score']"));
	 	goodScore.click();	 
	 	 WebElement gsText = driver.findElement(By.xpath("//h4[normalize-space()='Good Score']"));

	  	  if (gsText.isDisplayed()) {

...
public class TC_013_SignUP10 extends _2Baseclass_SignUp  {
	...
	@Test(dataProvider = "dataS")
		...
		/// here we select the Topics for Testing quiz...
		 ...
		 WebElement errorTC = driver.findElement(By.xpath("//div[@id='agreeerr']"));

		 SignInConditions sgnc = new SignInConditions();
		 sgnc.condSignUp(email,mNum, errorEmail , errorTC);
	...
	@DataProvider(name="dataS" , indices = {8}) /// here in indices we pass which rows data we want

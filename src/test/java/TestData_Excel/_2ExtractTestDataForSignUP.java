...
public class _2ExtractTestDataForSignUP {

	
	
	public static Object[][] SignUpTestData() throws IOException {
		
		 DataFormatter df = new DataFormatter(); /// Dataformatter is useful for Format the data into one type of data using its method.

		
		 FileInputStream file = new FileInputStream("C:\\Users\\Omkar\\eclipse-workspace\\com.qajbktest.Project.Automation\\ExcelSheets\\_2SignUPData.xlsx");
